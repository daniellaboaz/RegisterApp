...
import validation from './ValidationFolder/ShowValidation';
    ...
    <div className='d-flex justify-content-center align-items-center bg-primary vh-100'>
        <div className='bg-white p-3 rounded w-25'>
            ...
            <form action="" onSubmit={handleSubmit}>
                ...
                <button type='button' onClick={handleShowAll} className='btn btn-success w-100 rounded-0'>Show all user</button>
              ...
              <div className='users_to_show' style={{ maxHeight: '180px', overflowY: 'auto' }}>
          {users.length > 0 && (
